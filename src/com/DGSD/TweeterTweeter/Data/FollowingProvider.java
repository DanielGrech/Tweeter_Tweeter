 ...
 * Description:
 */
public class FollowingProvider extends BaseProvider {
    private static final String TAG = FollowingProvider.class.getSimpleName();

    protected static final String AUTHORITY = "com.DGSD.TweeterTweeter.Data.FollowingProvider";

    private static final String BASE_PATH = Database.Table.FOLLOWING;
    ...
    public String getTable() {
        return Database.Table.FOLLOWING;
    }
